 ...
 */
public class VideoPBOPlayer extends VLCPlayer {
     ...
     */
    @Deprecated
    public VideoPBOPlayer(Executor playerThreadEx) { this(null, playerThreadEx, DEFAULT_BUFFER_HELPER); }
     ...
     */
    @Deprecated
    public VideoPBOPlayer(MediaPlayerFactory factory, Executor playerThreadEx) { this(factory, playerThreadEx, DEFAULT_BUFFER_HELPER); }
     ...
     */
    @Deprecated
    public VideoPBOPlayer(Executor playerThreadEx, BufferHelper bufferHelper) { this(null, playerThreadEx, bufferHelper); }
     ...
     */
    @Deprecated
    public VideoPBOPlayer(MediaPlayerFactory factory, Executor playerThreadEx, BufferHelper bufferHelper) {
        super();
