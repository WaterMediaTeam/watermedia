...
public abstract class VLCPlayer {
    ...
    protected VLCPlayer(MediaPlayerFactory factory, RenderCallback renderCallback, SimpleBufferFormatCallback bufferFormatCallback) {
...
//            this.live = result.assumeStream;
    ...
    public long getDuration() {
        ...
        if (!isValid() || (Platform.isLinux() && this.isStopped())) return 0L;
