...
import me.lib720.caprica.vlcj.player.base.AudioTrackList;
import me.lib720.caprica.vlcj.player.base.TextTrackList;
import me.lib720.caprica.vlcj.player.base.TrackList;
import me.lib720.caprica.vlcj.player.base.VideoTrackList;
...
public final class TrackApi extends BaseApi {
    ...
    public VideoTrackList videoTracks() {
        libvlc_media_tracklist_t trackList = LibVlc.libvlc_media_get_tracklist(mediaInstance, TrackType.VIDEO.intValue());
        if (trackList != null) {
    ...
    public AudioTrackList audioTracks() {
        libvlc_media_tracklist_t trackList = LibVlc.libvlc_media_get_tracklist(mediaInstance, TrackType.AUDIO.intValue());
        if (trackList != null) {
    ...
    public TextTrackList textTracks() {
        libvlc_media_tracklist_t trackList = LibVlc.libvlc_media_get_tracklist(mediaInstance, TrackType.TEXT.intValue());
        if (trackList != null) {
