...
public final class TimeApi extends BaseApi {
    ...
    public boolean watchTime(long minimumPeriodBetweenUpdates, Long data, WatchTimeListener listener) {
        ...
        return 0 == LibVlc.libvlc_media_player_watch_time(
            mediaPlayerInstance,
    ...
    public void unwatchTime() {
        LibVlc.libvlc_media_player_unwatch_time(mediaPlayerInstance);
    ...
    public boolean interpolate(TimePoint timePoint) {
        ...
        boolean result = LibVlc.libvlc_media_player_time_point_interpolate(toInstance(timePoint), LibVlc.libvlc_clock(), out_ts, out_pos) == 0;
        if (result) {
    ...
    public long nextAbsoluteTimestamp(TimePoint timePoint, long interpolatedTimestamp, long nextInterval) {
        return LibVlc.libvlc_media_player_time_point_get_next_date(toInstance(timePoint), LibVlc.libvlc_clock(), interpolatedTimestamp, nextInterval);
    }
    ...
    public long nextRelativeTimestamp(TimePoint timePoint, long interpolatedTimestamp, long nextInterval) {
        ...
        return nextAbsoluteTimestamp(timePoint, interpolatedTimestamp, nextInterval) - LibVlc.libvlc_clock();
    }
