...
final class Win32FullScreenHandler {
    ...
    void setFullScreen(boolean fullScreen) {
        ...
        if (fullScreen) {
            ...
            ExtendedUser32.INSTANCE.SetWindowLong(hWnd, GWL_STYLE, windowState.getStyle() & ~(ExtendedUser32.WS_CAPTION | ExtendedUser32.WS_THICKFRAME));
            ExtendedUser32.INSTANCE.SetWindowLong(hWnd, GWL_EXSTYLE, windowState.getExStyle() & ~(ExtendedUser32.WS_EX_DLGMODALFRAME | ExtendedUser32.WS_EX_WINDOWEDGE | ExtendedUser32.WS_EX_CLIENTEDGE | ExtendedUser32.WS_EX_STATICEDGE));
            MONITORINFO monitorInfo = getMonitorInfo(hWnd);
            RECT rect = monitorInfo.rcMonitor;
            ExtendedUser32.INSTANCE.SetWindowPos(hWnd, null, rect.left, rect.top, rect.right - rect.left, rect.bottom - rect.top, ExtendedUser32.SWP_NOZORDER | ExtendedUser32.SWP_NOACTIVATE | ExtendedUser32.SWP_FRAMECHANGED);
        }
        else {
            ...
            ExtendedUser32.INSTANCE.SetWindowPos(hWnd, null, windowState.getLeft(), windowState.getTop(), windowState.getRight() - windowState.getLeft(), windowState.getBottom() - windowState.getTop(), ExtendedUser32.SWP_NOZORDER | ExtendedUser32.SWP_NOACTIVATE | ExtendedUser32.SWP_FRAMECHANGED);
