...
package me.lib720.caprica.support;

import me.lib720.caprica.support.version.Version;
...
public final class Info {
    ...
    private Version getVlcjVersion() {
        try {
            ...
            properties.load(getClass().getResourceAsStream("/me/lib720/caprica/build.properties"));
