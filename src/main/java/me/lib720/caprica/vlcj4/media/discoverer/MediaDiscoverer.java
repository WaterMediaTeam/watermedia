...
package me.lib720.caprica.vlcj4.media.discoverer;
...
public final class MediaDiscoverer {
    ...
    MediaDiscoverer(libvlc_instance_t libvlcInstance, libvlc_media_discoverer_t discovererInstance) {
        ...
        this.mediaList = new MediaList(libvlcInstance, LibVlc.libvlc_media_discoverer_media_list(discovererInstance));
    }
