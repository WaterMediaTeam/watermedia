...
package me.lib720.caprica.vlcj4.support;

import me.lib720.caprica.vlcj4.support.version.Version;
...
public final class Info {
    ...
    private Version getVlcjVersion() {
        try {
            ...
            properties.load(getClass().getResourceAsStream("/me/lib720/caprica/vlcj4/build.properties"));
