...
import me.lib720.caprica.binding.internal.libvlc_video_adjust_option_t;
...
public final class VideoApi extends BaseApi {
    ...
    public void setDeinterlace(int deinterlace, DeinterlaceMode deinterlaceMode) {
        LibVlc.libvlc_video_set_deinterlace(mediaPlayerInstance, deinterlace, deinterlaceMode != null ? deinterlaceMode.stringValue() : null);
    }
    ...
    public void setCropRatio(int num, int den) {
        LibVlc.libvlc_video_set_crop_ratio(mediaPlayerInstance, num, den);
    }
    ...
    public void setCropWindow(int x, int y, int width, int height) {
        if (width != 0 && height != 0) {
            LibVlc.libvlc_video_set_crop_window(mediaPlayerInstance, x, y, width, height);
        } else {
    ...
    public void setCropBorder(int left, int top, int right, int bottom) {
        LibVlc.libvlc_video_set_crop_border(mediaPlayerInstance, left, right, top, bottom);
    }
