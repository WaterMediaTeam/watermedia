...
import me.lib720.caprica.player.list.ControlsApi;
import me.lib720.caprica.player.list.EventApi;
import me.lib720.caprica.player.list.ListApi;
import me.lib720.caprica.player.list.MediaListPlayer;
import me.lib720.caprica.player.list.StatusApi;
import me.lib720.caprica.binding.internal.libvlc_media_t;
import me.lib720.caprica.medialist.MediaListRef;
...
public final class SubitemApi extends BaseApi {
    ...
    public void mode(SubItemMode mode) {
        ...
        if (mode == SubItemMode.NO_ACTION) {
            ...
            MediaListRef emptyListRef = new MediaListRef(libvlcInstance, LibVlc.libvlc_media_list_new(libvlcInstance));
            try {
