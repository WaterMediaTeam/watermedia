...
import me.lib720.caprica.player.base.callback.AudioCallback;
...
public final class AudioApi extends BaseApi implements EqualizerListener {
     ...
     * <p>
     * The output name comes from {@link me.lib720.caprica.factory.AudioApi#audioOutputs()}.
     *
     ...
     * {@link me.lib720.caprica.factory.AudioApi#audioOutputs()}.
     *
     * @param outputDeviceId id of the desired audio output device
     */
    public void setOutputDevice(String outputDeviceId) {
        LibVlc.libvlc_audio_output_device_set(mediaPlayerInstance, outputDeviceId);
    }
    ...
    public AudioStereoMode stereoMode() {
        return AudioStereoMode.audioStereoMode(LibVlc.libvlc_audio_get_stereomode(mediaPlayerInstance));
    }
    ...
    public boolean setStereoMode(AudioStereoMode stereoMode) {
        return LibVlc.libvlc_audio_set_stereomode(mediaPlayerInstance, stereoMode.intValue()) == 0;
    }
    ...
    public AudioMixMode getMixMode() {
        return AudioMixMode.audioMixMode(LibVlc.libvlc_audio_get_mixmode(mediaPlayerInstance));
    }
    ...
    public boolean setMixMode(AudioMixMode mixMode) {
        return LibVlc.libvlc_audio_set_mixmode(mediaPlayerInstance, mixMode.intValue()) == 0;
    }
