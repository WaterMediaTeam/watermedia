...
import me.lib720.caprica.binding.support.strings.NativeUri;
...
public final class SubpictureApi extends BaseApi {
    ...
    public float getTextScale() {
        return LibVlc.libvlc_video_get_spu_text_scale(mediaPlayerInstance);
    }
    ...
    public void setTextScale(float scale) {
        LibVlc.libvlc_video_set_spu_text_scale(mediaPlayerInstance, scale);
    }
