...
public final class Media {
    ...
    public MediaRef duplicateMediaRef() {
        return new MediaRef(libvlcInstance, LibVlc.libvlc_media_duplicate(mediaInstance));
    }
    ...
    public Media duplicateMedia() {
        return new Media(libvlcInstance, LibVlc.libvlc_media_duplicate(mediaInstance));
    }
