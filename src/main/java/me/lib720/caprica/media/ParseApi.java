...
public final class ParseApi extends BaseApi {
    ...
    public boolean parse(int timeout, ParseFlag... flags) {
        return LibVlc.libvlc_media_parse_request(libvlcInstance, mediaInstance, flagsToInt(flags), timeout) == 0;
    }
     ...
     */
    public void stop() {
        LibVlc.libvlc_media_parse_stop(libvlcInstance, mediaInstance);
    }
