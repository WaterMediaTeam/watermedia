...
import me.lib720.caprica.player.list.MediaListPlayer;
...
public final class MediaPlayerApi extends BaseApi {
    ...
    public MediaPlayer newMediaPlayer(MediaListPlayer mediaListPlayer) {
        return new MediaPlayer(libvlcInstance, LibVlc.libvlc_media_list_player_get_media_player(mediaListPlayer.mediaListPlayerInstance()));
    }
    ...
    public EmbeddedMediaPlayer newEmbeddedMediaPlayer(MediaListPlayer mediaListPlayer) {
        return new EmbeddedMediaPlayer(libvlcInstance, LibVlc.libvlc_media_list_player_get_media_player(mediaListPlayer.mediaListPlayerInstance()));
    }
