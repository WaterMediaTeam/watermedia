...
public final class DialogsApi extends BaseApi {
    ...
    public void enable(Dialogs dialogs, Long userData) {
        LibVlc.libvlc_dialog_set_error_callback(libvlcInstance, dialogs.errorCallback(), pointer(userData));
        LibVlc.libvlc_dialog_set_callbacks(libvlcInstance, dialogs.callbacks(), pointer(userData));
    }
    ...
    public void disable(Long userData) {
        LibVlc.libvlc_dialog_set_error_callback(libvlcInstance, null, pointer(userData));
        LibVlc.libvlc_dialog_set_callbacks(libvlcInstance, null, pointer(userData));
    }
