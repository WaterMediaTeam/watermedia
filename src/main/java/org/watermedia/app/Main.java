...
public class Main {
    ...
    public static final String JAR_PATH = Main.class.getProtectionDomain().getCodeSource().getLocation().toString().replace("file:///", "").replace("file:/", "");
    ...
    public static final ClassLoader CLASS_LOADER = me.srrapero720.watermedia.Main.class.getClassLoader();
    ...
    public static void runLogCollections() {
        ...
        EXECUTOR.execute(Main::task_collectLogs);
        EXECUTOR.execute(Main::task_collectCrashReports);
        EXECUTOR.execute(Main::task_collectHsErrPid);
        EXECUTOR.execute(Main::task_collectOsDetails);
        EXECUTOR.execute(Main::task_collectNetworkDetails);
        EXECUTOR.execute(() -> {
    ...
    private static void createWindow() {
        ...
        WINDOW.setIconImage(new ImageIcon(CLASS_LOADER.getResource("assets/wt_icon.png")).getImage());
        createLayout();
    ...
    private static void createLayout() {
        ...
        logo.setIcon(new ImageIcon(new ImageIcon(CLASS_LOADER.getResource("assets/wt_banner.png")).getImage().getScaledInstance(600, 100, Image.SCALE_FAST)));
