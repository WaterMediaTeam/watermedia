...
public abstract class AbstractPatch {
     ...
     */
    public abstract void patch(MRL source) throws PatchException;
    ...
    /**
     * Called by WaterMedia bootstrap when {@link org.watermedia.api.NetworkAPI NetworkAPI} is loaded
     */
    public void onStart() {
        LOGGER.info(IT, "Loaded {}", this.name());
    }

    /**
     * Called by WaterMedia bootstrap when {@link org.watermedia.api.NetworkAPI NetworkAPI} is released
     */
    public void onRelease() {
        LOGGER.info(IT, "Releasing {}", this.name());
    }
